...
#define CONF_TCC0_ADVANCED_CONFIGURATION_ENABLE 1
#endif
...
#define CONF_TCC0_CTRLA                                                                                                \
	TCC_CTRLA_PRESCALER(CONF_TCC0_PRESCALER) | (CONF_TCC0_RUNSTDBY << TCC_CTRLA_RUNSTDBY_Pos)                          \
	    | TCC_CTRLA_PRESCSYNC(CONF_TCC0_PRESCSYNC) | (CONF_TCC0_ALOCK << TCC_CTRLA_ALOCK_Pos)                          \
	    | (CONF_TCC0_CPTEN0 << TCC_CTRLA_CPTEN0_Pos) | (CONF_TCC0_CPTEN1 << TCC_CTRLA_CPTEN1_Pos)                      \
	    | (CONF_TCC0_CPTEN2 << TCC_CTRLA_CPTEN2_Pos) | (CONF_TCC0_CPTEN3 << TCC_CTRLA_CPTEN3_Pos)
...
#define CONF_TCC0_EVCTRL                                                                                               \
	TCC_EVCTRL_CNTSEL(CONF_TCC0_CNTSEL) | (CONF_TCC0_OVFEO << TCC_EVCTRL_OVFEO_Pos)                                    \
	    ...
	    | (CONF_TCC0_MCEO0 << TCC_EVCTRL_MCEO0_Pos) | (CONF_TCC0_MCEO1 << TCC_EVCTRL_MCEO1_Pos)                        \
	    | (CONF_TCC0_MCEO2 << TCC_EVCTRL_MCEO2_Pos) | (CONF_TCC0_MCEO3 << TCC_EVCTRL_MCEO3_Pos)                        \
	    | (CONF_TCC0_MCEI0 << TCC_EVCTRL_MCEI0_Pos) | (CONF_TCC0_MCEI1 << TCC_EVCTRL_MCEI1_Pos)                        \
	    | (CONF_TCC0_MCEI2 << TCC_EVCTRL_MCEI2_Pos) | (CONF_TCC0_MCEI3 << TCC_EVCTRL_MCEI3_Pos)                        \
